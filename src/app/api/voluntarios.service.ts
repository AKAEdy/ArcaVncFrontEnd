...
export class VoluntariosService {
     ...
     */
    public createUsingPOST9(body: VoluntarioDto, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createUsingPOST9(body: VoluntarioDto, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createUsingPOST9(body: VoluntarioDto, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createUsingPOST9(body: VoluntarioDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUsingPUT9(body: VoluntarioDto, idVoluntario: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateUsingPUT9(body: VoluntarioDto, idVoluntario: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateUsingPUT9(body: VoluntarioDto, idVoluntario: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateUsingPUT9(body: VoluntarioDto, idVoluntario: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (idVoluntario === null || idVoluntario === undefined) {
            throw new Error('Required parameter idVoluntario was null or undefined when calling updateUsingPUT9.');
        }
