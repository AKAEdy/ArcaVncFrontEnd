...
import { PageAdoptante } from '../model/pageAdoptante';
...
export class AdoptanteControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllAdoptantesUsingGET(page: number, size: number, observe?: 'body', reportProgress?: boolean): Observable<PageAdoptante>;
    public getAllAdoptantesUsingGET(page: number, size: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageAdoptante>>;
    public getAllAdoptantesUsingGET(page: number, size: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageAdoptante>>;
    public getAllAdoptantesUsingGET(page: number, size: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (page === null || page === undefined) {
            throw new Error('Required parameter page was null or undefined when calling getAllAdoptantesUsingGET.');
        }

        if (size === null || size === undefined) {
            throw new Error('Required parameter size was null or undefined when calling getAllAdoptantesUsingGET.');
        }
        ...
        return this.httpClient.request<PageAdoptante>('get',`${this.basePath}/api/adoptantes/`,
            {
