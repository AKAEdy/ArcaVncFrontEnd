...
export class RolesService {
     ...
     */
    public createUsingPOST5(body: RolDto, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createUsingPOST5(body: RolDto, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createUsingPOST5(body: RolDto, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createUsingPOST5(body: RolDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    public getByIdUsingGET5(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('get',`${this.basePath}/roles/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getRolsUsingGET(page: number, size: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (page === null || page === undefined) {
            throw new Error('Required parameter page was null or undefined when calling getRolsUsingGET.');
        }

        if (size === null || size === undefined) {
            throw new Error('Required parameter size was null or undefined when calling getRolsUsingGET.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUsingPUT5(body: RolDto, id: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateUsingPUT5(body: RolDto, id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateUsingPUT5(body: RolDto, id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateUsingPUT5(body: RolDto, id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('put',`${this.basePath}/roles/${encodeURIComponent(String(id))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
