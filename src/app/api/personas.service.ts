...
export class PersonasService {
     ...
     */
    public createUsingPOST4(body: Persona, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createUsingPOST4(body: Persona, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createUsingPOST4(body: Persona, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createUsingPOST4(body: Persona, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUsingPUT4(body: Persona, id: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateUsingPUT4(body: Persona, id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateUsingPUT4(body: Persona, id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateUsingPUT4(body: Persona, id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
