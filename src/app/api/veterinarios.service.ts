...
export class VeterinariosService {
     ...
     */
    public createUsingPOST9(body: Veterinario, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createUsingPOST9(body: Veterinario, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createUsingPOST9(body: Veterinario, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createUsingPOST9(body: Veterinario, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUsingPUT9(body: Veterinario, id: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateUsingPUT9(body: Veterinario, id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateUsingPUT9(body: Veterinario, id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateUsingPUT9(body: Veterinario, id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
