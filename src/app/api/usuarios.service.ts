...
export class UsuariosService {
     ...
     */
    public createUsingPOST7(body: Usuario, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createUsingPOST7(body: Usuario, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createUsingPOST7(body: Usuario, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createUsingPOST7(body: Usuario, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUsingPUT7(body: Usuario, id: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateUsingPUT7(body: Usuario, id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateUsingPUT7(body: Usuario, id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateUsingPUT7(body: Usuario, id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
