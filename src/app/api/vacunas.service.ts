...
export class VacunasService {
     ...
     */
    public createUsingPOST8(body: Vacuna, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public createUsingPOST8(body: Vacuna, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public createUsingPOST8(body: Vacuna, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public createUsingPOST8(body: Vacuna, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUsingPUT8(body: Vacuna, id: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public updateUsingPUT8(body: Vacuna, id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public updateUsingPUT8(body: Vacuna, id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public updateUsingPUT8(body: Vacuna, id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
